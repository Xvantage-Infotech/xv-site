...
function Contact() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Contact Us | Xvantage Infotech - Let’s Build Something Great Together
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Xvantage Infotech, contact Xvantage, tech company, web development, mobile app, AI/ML, IT services, digital solutions"
        />
        <meta property="og:title" content="Contact Xvantage Infotech" />
        <meta
          property="og:description"
          content="Reach out to Xvantage Infotech — your trusted partner for innovative web, mobile, and AI-powered solutions."
        />
        <meta property="og:image" content="/xvantage_logo_copy.png" />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://xvantageinfotech.com/contact"
        />
      </Helmet>
