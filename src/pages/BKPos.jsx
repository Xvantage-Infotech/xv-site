...
const BKPos = () => {
  ...
  return (
    <div id="bkpos" className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
            ...
            >
              <h1 className="text-4xl sm:text-6xl lg:text-6xl font-bold mt-32 mb-8 leading-tight">
                ...
                <motion.div
                    ...
                    Byting Korner is a sleek, intuitive Point of Sale (POS) system developed for small to mid-sized outlets, enabling seamless sales processing, 
                    real-time inventory management, and actionable business insights. Built with scalability and simplicity in mind, it powers QSR outlets
                     across India through an easy-to-learn, hard-to-break system optimized for speed, security, and performance
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                                  Simplicity, Speed, Clarity, Consistency, Scalablity, Fast checkouts, Reduce Staff Training Time, Easy login .
                                </p>
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                               Dashboard with Sales Analytics, Inventory Management, Order Management, Customer Management, Multi-Outlet Support,Sales Reports, Notification Panel
                                </p>
                              </motion.div>
                            </div>
                          </motion.div>
