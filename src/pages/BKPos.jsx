  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Byting Korner POS is a fast, reliable Point of Sale system developed by Xvantage Infotech for small and medium businesses. It offers real-time inventory management, analytics, multi-outlet support, and a seamless sales experience designed for scalability and speed."
        />

        <meta
          name="keywords"
          content="Byting Korner, POS system, point of sale, inventory management, billing software, Xvantage Infotech, sales dashboard, business analytics, retail POS, multi-outlet POS"
        />

        <meta
          property="og:title"
          content="Byting Korner POS - Smart Retail & QSR Management System"
        />
        <meta
          property="og:description"
          content="Experience a modern, fast, and secure POS system with Byting Korner by Xvantage Infotech. Manage billing, inventory, customers, and reports—all from one place."
        />
        <meta property="og:image" content="/BKPOS.jpg" />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://xvantageinfotech.com/bkpos" />
      </Helmet>
        ...
        <p className="text-xl mb-6 leading-tight  ">{project.desc}</p> */}
          ...
          >
            <p className="text-lg sm:text-xl text-gray-400 max-w-6xl mb-20">
              Byting Korner is a sleek, intuitive Point of Sale (POS) system
              developed for small to mid-sized outlets, enabling seamless sales
              processing, real-time inventory management, and actionable
              business insights. Built with scalability and simplicity in mind,
              it powers QSR outlets across India through an easy-to-learn,
              hard-to-break system optimized for speed, security, and
              performance
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <h3 className="text-2xl font-bold mb-4">Important Keys</h3>
                <p className="text-gray-400">
                  Simplicity, Speed, Clarity, Consistency, Scalablity, Fast
                  checkouts, Reduce Staff Training Time, Easy login .
                </p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400">
                  Dashboard with Sales Analytics, Inventory Management, Order
                  Management, Customer Management, Multi-Outlet Support,Sales
                  Reports, Notification Panel
                </p>
              </motion.div>
            </div>
          </motion.div>
