...
const SpyGame = () => {
  ...
  return (
    <div id="spygame" className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
            ...
            >
              <h1 className="text-4xl sm:text-6xl lg:text-6xl font-bold mt-32 mb-8 leading-tight">
                ...
                <motion.div
                   ...
                   Spy Game is a thrilling party-style impostor game built for spontaneous fun with friends—whether at a party, dinner, school, or work. 
                   Designed to emulate the excitement of classics like Mafia and Spyfall, 
                   the app supports both online and offline modes, ensuring accessibility and engagement for everyone. No ads. Just pure social deception and strategy.
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              ...
                              >
                                <h3 className="text-2xl font-bold mb-4">Challenges While Making This Game</h3>
