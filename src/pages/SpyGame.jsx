  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Spy Game is a thrilling social deduction party game by Xvantage Infotech. Play online or offline with friends, uncover the spy, and experience the excitement of deception and strategy—no ads, just pure fun!"
        />

        <meta
          name="keywords"
          content="Spy Game, social game, party game, multiplayer strategy, spyfall, mafia, impostor game, Xvantage Infotech, mobile games, online offline game"
        />

        <meta
          property="og:title"
          content="Spy Game - Multiplayer Party Game by Xvantage Infotech"
        />
        <meta
          property="og:description"
          content="Play Spy Game — a fun, fast-paced social deduction game. Challenge friends online or offline and uncover the spy before time runs out!"
        />
        <meta property="og:image" content="/SpyGame.jpg" />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://xvantageinfotech.com/spygame"
        />
      </Helmet>
        ...
        <p className="text-xl mb-6 leading-tight  ">{project.desc}</p> */}
          ...
          >
            <p className="text-lg sm:text-xl text-gray-400 max-w-6xl mb-20">
              Spy Game is a thrilling party-style impostor game built for
              spontaneous fun with friends—whether at a party, dinner, school,
              or work. Designed to emulate the excitement of classics like Mafia
              and Spyfall, the app supports both online and offline modes,
              ensuring accessibility and engagement for everyone. No ads. Just
              pure social deception and strategy.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <h3 className="text-2xl font-bold mb-4">
                  Challenges While Making This Game
                </h3>
                <p className="text-gray-400">
                  Preventing role leaks during pass-the-phone play.
                </p>
                <p className="text-gray-400">
                  Managing real-time sync with low latency.
                </p>
                <p className="text-gray-400">Balancing word difficulty.</p>
                <p className="text-gray-400">No internet at parties.</p>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-400">
                  Genre: Social | MultiPlayer | Strategy
                </p>
                <p className="text-gray-400">Mode: Online | Offline</p>
              </motion.div>
            </div>
          </motion.div>
