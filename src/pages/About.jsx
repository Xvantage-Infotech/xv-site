...
import { socialIcon, teamMember } from "../constants/data";
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Learn more about Xvantage Infotech — a leading technology company specializing in web development, mobile app creation, and AI/ML innovations. We empower businesses through digital excellence."
        />
        <meta
          name="keywords"
          content="Xvantage Infotech, About Xvantage, tech company, web development, AI/ML development, mobile app development, digital transformation"
        />
        <meta property="og:title" content="About Xvantage Infotech" />
        <meta
          property="og:description"
          content="Discover Xvantage Infotech’s mission, vision, and expert team — delivering innovative digital solutions worldwide."
        />
