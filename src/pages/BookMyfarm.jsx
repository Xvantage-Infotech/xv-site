...
const BookMyFarm = () => {
  ...
  return (
    <div id="bookmyfarm" className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
            ...
            >
              <h1 className="text-4xl sm:text-6xl lg:text-6xl font-bold mt-32 mb-8 leading-tight">
                ...
                <motion.div
                    ...
                    Get started with Book My Farm through a quick and friendly onboarding flow. From welcoming visuals to secure phone number verification, 
                    the process is designed to help users access personalized bookings and farm stay experiences effortlessly.
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                                  Our goal was to build a trusted, Modern platform where users could book farmhouses as easily as booking a movie ticket, 
                                  and where property owners could manage their listings with ease.
                                </p>
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                               Perfect Farms, Villa, Apartment Booking for your dreamy vacation with easy to use app and website with best discount on card.
                                </p>
                              </motion.div>
                            </div>
                          </motion.div>
