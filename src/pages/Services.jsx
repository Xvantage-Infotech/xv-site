...
import { socialIcon, services } from "../constants/data";
...
function Services() {
  ...
  return (
    <>
      <Helmet>
        <title>
          Our Services | Xvantage Infotech - Web, Mobile & AI/ML Solutions
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Xvantage Infotech services, web development, mobile app development, AI/ML solutions, software development, IT services, digital transformation"
        />
        <meta property="og:title" content="Our Services - Xvantage Infotech" />
        <meta
          property="og:description"
          content="Xvantage Infotech offers world-class web, mobile, and AI/ML solutions to help businesses innovate and scale efficiently."
        />
        <meta property="og:image" content="/xvantage_logo_copy.png" />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://xvantageinfotech.com/services"
        />
      </Helmet>
