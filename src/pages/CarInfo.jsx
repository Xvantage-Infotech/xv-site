...
const CarInfo = () => {
  ...
  return (
    <div id="carinfo" className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
            ...
            >
              <h1 className="text-4xl sm:text-6xl lg:text-6xl font-bold mt-32 mb-8 leading-tight">
                ...
                <motion.div
                    ...
                    CarInfo+ is a mobile application designed to provide users with instant access to driving licences, 
                    vehicle registrations, RTO codes, safety ratings, and more. The app aims to be a one-stop solution for car enthusiasts, prospective buyers, 
                    and individuals seeking reliable vehicle and driving licence details
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                                  Provide a seamless experience for accessing vehicle and licence information.
                                </p>
                                 <p className="text-gray-400">
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                                RC Details, Challan Details, Buy Fastag, NearBy Car Wash, Petrol Pump, Charging Station, Garage, Book A Cab, Buy Products, Fuel Expense, EMI Calculation.
                                </p>
                              </motion.div>
                            </div>
                          </motion.div>
