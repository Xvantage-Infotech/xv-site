  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="The Book My Farm Admin Panel by Xvantage Infotech is a robust dashboard for managing farm bookings, users, properties, revenue, and owner payouts—all in one place with real-time analytics and control."
        />

        <meta
          name="keywords"
          content="Book My Farm, admin dashboard, property management, booking system, analytics, revenue dashboard, Xvantage Infotech, farm management platform"
        />

        <meta
          property="og:title"
          content="Book My Farm Admin Panel - Manage Bookings & Revenue"
        />
        <meta
          property="og:description"
          content="A modern, full-featured admin panel to manage farms, users, bookings, and payouts efficiently — built by Xvantage Infotech for Book My Farm."
        />
        <meta property="og:image" content="/BMFAdminPanel.jpg" />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://xvantageinfotech.com/bmf-adminpanel"
        />
      </Helmet>
        ...
        <p className="text-xl mb-6 leading-tight  ">{project.desc}</p> */}
          ...
          >
            <p className="text-lg sm:text-xl text-gray-400 max-w-6xl mb-20">
              Designing and developing the complete Super Admin Dashboard for
              BookMyFarm — a powerful system to manage bookings, farm
              availability, revenue, and owner payouts.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-gray-400">
                  we built the BookMyFarm Super Admin Dashboard — a full-cycle
                  solution that gives administrators complete visibility and
                  control over the platform’s farm bookings, income analytics,
              ...
              >
                ...
                <p className="text-gray-400">
                  Dashboard, Booking Slip, Farms & Properties, Marketing,
                  Customers & Users, Bank Details, Owner Payout.
                </p>
              </motion.div>
            </div>
          </motion.div>
