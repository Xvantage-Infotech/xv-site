...
const AgeCalcDetail = () => {
  ...
  return (
    <div id="agecalc" className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
                ...
                <motion.div
                          ...
                          >
                            <p className="text-lg sm:text-xl text-gray-400 max-w-6xl mb-20">
                                 your smart, all-in-one age calculation toolkit! Quickly find your exact age, compare birthdays, explore fun facts, and plan ahead with personalized tools.
     Whether you're tracking milestones or just curious, AgeCalc makes it simple, fast, and surprisingly insightful.
     Let’s get started!
                            </p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                                 ...
                                 <p className="text-gray-400">
                                  Deliver small, delightful facts that boost engagement and app loyalty.
                                </p>
                              </motion.div>
                              ...
                              >
                                ...
                                <p className="text-gray-400">
                                  Date Calculator, Age Comparison, Facts Calculator, Working Day Calculator, Time Calculator, Lunal Age Calculator, Generation Category, Zodiac Signs.
                                </p>
                              </motion.div>
                            </div>
                          </motion.div>
