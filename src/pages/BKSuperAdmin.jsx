...
const BKSuperAdmin = () => {
  ...
  return (
    <div id="bksuperadmin" className="min-h-screen bg-[#0A0A0A] text-white overflow-hidden">
            ...
            >
              <h1 className="text-4xl sm:text-6xl lg:text-6xl font-bold mt-32 mb-8 leading-tight">
                ...
                <motion.div
                    ...
                    Building a powerful Super Admin Dashboard for Byting Korner a complete system for franchise management, sales monitoring, 
                    stock control, and real-time communication
                            </p>
