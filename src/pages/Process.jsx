  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Discover the step-by-step process at Xvantage Infotech — from strategy and design to development and deployment. We transform ideas into powerful digital solutions."
        />
        <meta
          name="keywords"
          content="Xvantage Infotech process, software development process, web development steps, mobile app process, AI/ML workflow, IT solutions"
        />
        <meta property="og:title" content="Our Process - Xvantage Infotech" />
        <meta
          property="og:description"
          content="Learn how Xvantage Infotech turns ideas into innovation through a transparent and strategic digital development process."
        />
        <meta property="og:image" content="/xvantage_logo_copy.png" />
        <meta property="og:type" content="website" />
        <meta
          property="og:url"
          content="https://xvantageinfotech.com/process"
        />
      </Helmet>
